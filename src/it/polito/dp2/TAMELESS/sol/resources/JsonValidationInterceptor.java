...
public class JsonValidationInterceptor implements ReaderInterceptor {
	final String jaxbPackage = "it.polito.dp2.TAMELESS.sol.service.jaxb";
	Schema schema;
	JAXBContext jc;
	Logger logger;
	...
	public JsonValidationInterceptor() {
	    ...
	    try {
			InputStream schemaStream = XmlValidationProvider.class.getResourceAsStream("/xsd/tameless.xsd");
