 ...
 *         &lt;element ref="{}relation2Entities" maxOccurs="20" minOccurs="0"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
public class Relations2Entities {
    ...
    protected List<Relation2Entities> relation2Entities;
     ...
     * {@link Relation2Entities }
     * 
     * 
     */
    public List<Relation2Entities> getRelation2Entities() {
        if (relation2Entities == null) {
            relation2Entities = new ArrayList<Relation2Entities>();
        }
